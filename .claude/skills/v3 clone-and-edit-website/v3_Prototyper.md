...
**Upstream input:** Project Brief + all user-uploaded assets + `USER_JOURNEY_A.html`, `USER_JOURNEY_B.html`, `USER_JOURNEY_C.html` + `MOCKUP_A.html`, `MOCKUP_B.html`, `MOCKUP_C.html` from Designer Agent.
...
UPSTREAM HANDOFF VALIDATION
  USER_JOURNEY_A.html present:                     [yes / no]
  USER_JOURNEY_B.html present:                     [yes / no]
  USER_JOURNEY_C.html present:                     [yes / no]
  MOCKUP_A.html present with Part A + Part B:      [yes / no]
  MOCKUP_B.html present with Part A + Part B:      [yes / no]
  MOCKUP_C.html present with Part A + Part B:      [yes / no]
  ...
  Anchor A filename in Direction A token block:    [yes / no — if no, escalate to Designer Agent]
  Anchor B filename in Direction B token block:    [yes / no — if no, escalate to Designer Agent]
  Anchor C filename in Direction C token block:    [yes / no — if no, escalate to Designer Agent]
  Direction A palette traces to Anchor A:          [yes / no — verify hex values match extracted anchor values]
  Direction B palette traces to Anchor B:          [yes / no — verify hex values match extracted anchor values]
  Direction C palette traces to Anchor C:          [yes / no — verify hex values match extracted anchor values]
...
<head>
  ...
  Built from: MOCKUP_[A|B|C].html + USER_JOURNEY_[A|B|C].html + PROJECT_BRIEF.md
  ───────────────────────────────────────────────────────────────────────
  DESIGNER QUALITY SCORES
    Clean: [N/5] | Effective: [N/5] | Intuitive: [N/5] | Visually Pleasing: [N/5]
  ───────────────────────────────────────────────────────────────────────
